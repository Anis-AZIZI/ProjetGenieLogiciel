 ...
 * (sa clé sera nécessairement un Integer contenant l'index de l'objet).
 * 
 ...
 */
 ...
 public abstract class AbstractListDao<T> implements Dao<T> {
     ...
     public void delete(final T element) throws NameNotFoundException {
      ...
      // On préfère remplacer les éléments supprimés par NULL, quitte à augmenter
     ...
     @Override
     public Integer getId(final T element) {
     ...
     *
     * @return un entier qui est l'index de l'élément dans la liste ou -1 s'il n'a
     * pas été trouvé
     */

    private Integer getKeyForElement(final T element) {
        return this.collection.indexOf(element);
     }

     /**
      * Gets the underlying collection of elements.
      *
