...
/**
 * Interface de DAO générique : indépendante du type d'objet,
 * de la structure de stockage (liste ou map) et du type des identifiants (string ou entier).<br>
 * Si un support de persistance devait être ajouté au projet,
 * il le serait dans les classes d'implémentation de cette interface.<br>
 * <em>Note :</em> on pourra enrichir les DAOs de méthodes métier spécifiques dans les classes
 * terminales
...
public interface Dao<T> {
     ...
     * @throws NameAlreadyBoundException Si la clé utilisée pour
     * ajouter l'élément est déjà existante
     ...
     * @throws NameNotFoundException Si l'élément à supprimer n'a pas été trouvé
     * @throws InvalidNameException Si la syntaxe de la clé n'est pas conforme au type attendu
     */
     ...
     * @throws NameNotFoundException Si la clé de l'élément à rechercher n'a pas été trouvée
     * @throws InvalidNameException Si la syntaxe de la clé n'est pas conforme au type attendu
     */
    T findOne(Serializable id) throws NameNotFoundException, InvalidNameException;
         ...
         * 
         * @return La collection d'éléments stockés
         */
